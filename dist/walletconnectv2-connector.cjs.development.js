...
var UniversalProvider = _interopDefault(require('@walletconnect/universal-provider'));
var ethers = require('ethers');
var standalone = require('@web3modal/standalone');
...
var WalletConnectConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  function WalletConnectConnector() {
    return _AbstractConnector.call(this, {
    ...
    var _activate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            web3Modal = new standalone.Web3Modal({
              projectId: projectId,
              defaultChain: [1284],
...
//# sourceMappingURL=walletconnectv2-connector.cjs.development.js.map
